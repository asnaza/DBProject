                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav">
                    <li class="nav-item active">
                      <a class="nav-link" href="insert_sp.php" >Create<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
...
$sql = "SELECT * FROM Salesperson_13009";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr>
	     ...
	     <td>".$row["ContactNo"]."</td>
	     <td>".$row["CustomerAssigned"]."</td>";
	      
	echo "<td>";
            // we will use this links on next part of this post
            echo "<a href='update_sp.php?id={$row["SalespersonID"]}' class='btn btn-primary m-r-1em'>Edit</a>";
 	echo " ";
            // we will use this links on next part of this post
            echo "<a href='#' onclick='delete_user({$row["SalespersonID"]});'  class='btn btn-danger'>Delete</a>";
        echo "</td>";
	 echo "</tr>";
    }
    echo "</table>";
...
function delete_user( id ){
    ...
    if (answer){
        ...
        window.location = 'delete_sp.php?id=' + id;
    } 
}
</script>
</body>
