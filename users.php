                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav">
                    <li class="nav-item active">
                      <a class="nav-link" href="insert_u.php" >Create<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
...
if ($result->num_rows > 0) {
	...
	echo "<td>";
            ...
            echo "<a href='update_u.php?id={$row["UserID"]}' class='btn btn-primary m-r-1em'>Edit</a>";
 	echo " ";
            // we will use this links on next part of this post
            echo "<a href='delete_u.php?id={$row['UserID']}' class='btn btn-danger'>Delete</a>";
        echo "</td>";
	 echo "</tr>";
    }
    echo "</table>";
